...
function NavBar3() {
    ...
    return (
        <Navbar className="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
            ...
            <Link className="navbar-brand" to="/user/dashboard"><img src={logo} alt="logo" width="60px" height="40px" /></Link>

            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="me-auto">
                    <Nav.Link href="">About us</Nav.Link>
                    <NavDropdown title="Assets" id="collasible-nav-dropdown">
                        <NavDropdown.Item href="/asset2/all">View Assets</NavDropdown.Item>
                    </NavDropdown>
