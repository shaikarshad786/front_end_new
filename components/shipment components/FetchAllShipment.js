...
function FetchAllShipment() { 
    ...
    return (
        <div style={{ backgroundImage: `url(${a1})`, width: "100%", height: "1050px" }}>
            <NavBar/>
                        ...
                        shipments.map((shipment, index) =>
                            <div key={index} className="col-sm-3"><br></br>
                                <Link to={`${shipment.shipId}`}>
                                    <div className="card" style={{ width: "200px", height: "350px", backgroundColor: "transparent", color: "blue" }}>
                                        {/* eslint-disable-next-line */}
...
export default FetchAllShipment;